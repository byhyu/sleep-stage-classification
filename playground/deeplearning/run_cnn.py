...
from pysleep.data.data_generator import prepare_train_test, create_dataset, DataGenerator
from pysleep.models.cnn_models import CNN3Head
...
model = CNN3Head(model_name='CNN3Head_train10_test0', epochs=25, learning_rate=0.001, batch_size=16,
                 metric='accuracy')
model.build_model()
