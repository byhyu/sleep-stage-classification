...
from pysleep.models.models import cnn_cnn, cnn_cnn_1, cnn_v0
...
def test_cnn_v01():
    from pysleep.models.models import cnn_v01
    model = cnn_v01()
    train, val, test = prepare_train_test()
    X,y = create_dataset(train[0:10])
    hist = model.fit(X, y, batch_size=4, epochs=5, callbacks=callbacks)
    print(hist.history)
